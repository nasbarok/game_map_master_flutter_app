...
class TreasureHuntConfigScreen extends StatefulWidget {
  ...
  @override
  _TreasureHuntConfigScreenState createState() =>
      _TreasureHuntConfigScreenState();
}
...
class _TreasureHuntConfigScreenState extends State<TreasureHuntConfigScreen> {
  ...
  Future<void> _loadScenario() async {
    ...
    try {
      ...
      final scenario = await treasureHuntService
          .ensureTreasureHuntScenario(widget.scenarioId);
      ...
      setState(() {
        ...
        _countController.text = scenario.totalTreasures > 0
            ? scenario.totalTreasures.toString()
            : '10';
                      ...
                      children: [
                        ...
                        if (_scenario != null &&
                          ...
                          OutlinedButton(
                            ...
                            child: Text(
                              l10n.viewExistingTreasuresButton(
                                  _scenario!.totalTreasures.toString()),
                              style: const TextStyle(fontSize: 16),
                            ),
                          ),
                        ],
